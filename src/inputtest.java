...
class inputtest {
    ...
    void testChrome() throws  InterruptedException {
        ...
        search_name.sendKeys("พันแสน");
        search_lastname.sendKeys("สมกล้า");
        ...
        search_nameEN.sendKeys("Punsan");
        search_lastnameEN.sendKeys("Somkla");
        ...
        search_card.sendKeys("1659856325697");
        search_birthday.sendKeys("25/08/2546");
        search_phone.sendKeys("0922932011");
        search_email.sendKeys("654259026@webmail.npru.ac.th");
